...
typedef struct cublasLtMatmul_record
{
	...
	cublasLtMatmul_record(cublasLtHandle_t lightHandle_arg, cublasLtMatmulDesc_t computeDesc_arg, const void *alpha_arg, const void *A_arg, cublasLtMatrixLayout_t Adesc_arg, const void *B_arg, cublasLtMatrixLayout_t Bdesc_arg, const void *beta_arg, const void *C_arg, cublasLtMatrixLayout_t Cdesc_arg, void *D_arg, cublasLtMatrixLayout_t Ddesc_arg, const cublasLtMatmulAlgo_t *algo_arg, void *workspace_arg, size_t workspaceSizeInBytes_arg, cudaStream_t stream_arg)
	{
