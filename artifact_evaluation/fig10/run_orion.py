...
for (be, hp, f, max_be_duration) in trace_files:
    for run in range(num_runs):
        ...
        os.system(f"LD_PRELOAD='/orion/src/cuda_capture/libinttemp.so' python3.8 ../../benchmarking/launch_jobs.py --algo orion --config_file {file_path} --orion_max_be_duration {max_be_duration}")
