...
df_raw = pd.read_csv(f'{pwd}/raw.csv')
df_basic = pd.read_csv(f'{pwd}/output_16_train_processed_sms.csv', index_col=0)
...
df_basic.to_csv(f'{pwd}/output_16_train_processed_sms.csv')

print(f"comp bound: {comp_bound}, mem bound: {mem_bound}")
